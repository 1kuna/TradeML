...
_CAPABILITIES: tuple[VendorCapability, ...] = (
    ...
    VendorCapability(
        capability_id="alpaca.news.research",
        vendor="alpaca",
        dataset="news",
        ...
        rotation_key="alpaca:news",
        doc_urls=("https://docs.alpaca.markets/reference/news-3",),
    ),
    VendorCapability(
        capability_id="alpaca.stock_trades.research",
        vendor="alpaca",
        ...
        expected_history_years=1,
        required_fields=("symbol", "event_type", "vendor_ts", "price", "size"),
        priority=260,
        lane_width=1,
        output_name="alpaca_market_events",
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=100,
        rotation_key="alpaca:stock_trades",
        doc_urls=("https://docs.alpaca.markets/reference/stocktrades",),
    ),
    VendorCapability(
        capability_id="alpaca.stock_quotes.research",
        vendor="alpaca",
        ...
        live_status="live_failed",
        expected_history_years=1,
        required_fields=("symbol", "event_type", "vendor_ts", "bid_price", "ask_price"),
        priority=261,
        lane_width=1,
        output_name="alpaca_market_events",
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=100,
        rotation_key="alpaca:stock_quotes",
        doc_urls=("https://docs.alpaca.markets/reference/stockquotes",),
    ),
    VendorCapability(
        capability_id="alpaca.stock_snapshots.research",
        vendor="alpaca",
        dataset="stock_snapshots",
        ...
        required_fields=("symbol", "asset_class", "feed"),
        priority=262,
        lane_width=1,
        output_name="alpaca_snapshots",
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=100,
        rotation_key="alpaca:stock_snapshots",
        doc_urls=("https://docs.alpaca.markets/reference/stocksnapshots",),
    ),
    VendorCapability(
        capability_id="alpaca.stock_bars_boats.research",
        vendor="alpaca",
        dataset="stock_bars_boats",
        endpoint="/v2/stocks/bars?feed=boats",
        auth_mode="headers",
        batching_mode="multi_symbol",
        pagination_mode="token",
        task_kind="RESEARCH_ONLY",
        ...
        live_status="live_failed",
        expected_history_years=1,
        required_fields=("date", "symbol", "open", "high", "low", "close", "vendor_ts"),
        priority=263,
        lane_width=1,
        output_name="stock_bars_extended",
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=100,
        rotation_key="alpaca:stock_bars_boats",
        doc_urls=("https://docs.alpaca.markets/reference/stockbars",),
    ),
    VendorCapability(
        capability_id="alpaca.stock_bars_otc.research",
        vendor="alpaca",
        dataset="stock_bars_otc",
        endpoint="/v2/stocks/bars?feed=otc",
        auth_mode="headers",
        batching_mode="multi_symbol",
        pagination_mode="token",
        task_kind="RESEARCH_ONLY",
        ...
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=100,
        rotation_key="alpaca:stock_bars_otc",
        doc_urls=("https://docs.alpaca.markets/reference/stockbars",),
    ),
    VendorCapability(
        capability_id="alpaca.crypto_bars.research",
        vendor="alpaca",
        dataset="crypto_bars",
        ...
        priority=270,
        lane_width=1,
        output_name="crypto_bars",
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=25,
        explode_symbols=False,
        rotation_key="alpaca:crypto_bars",
        doc_urls=("https://docs.alpaca.markets/reference/cryptobars-1",),
    ),
    VendorCapability(
        capability_id="alpaca.crypto_trades.research",
        vendor="alpaca",
        dataset="crypto_trades",
        ...
        max_symbols_per_run=25,
        explode_symbols=False,
        rotation_key="alpaca:crypto_trades",
        doc_urls=("https://docs.alpaca.markets/reference/cryptotrades-1",),
    ),
    VendorCapability(
        capability_id="alpaca.crypto_quotes.research",
        vendor="alpaca",
        dataset="crypto_quotes",
        ...
        max_symbols_per_run=25,
        explode_symbols=False,
        rotation_key="alpaca:crypto_quotes",
        doc_urls=("https://docs.alpaca.markets/reference/cryptoquotes-1",),
    ),
    VendorCapability(
        capability_id="alpaca.crypto_snapshots.research",
        vendor="alpaca",
        dataset="crypto_snapshots",
        ...
        max_symbols_per_run=25,
        explode_symbols=False,
        rotation_key="alpaca:crypto_snapshots",
        doc_urls=("https://docs.alpaca.markets/reference/cryptosnapshots-1",),
    ),
    VendorCapability(
        capability_id="alpaca.crypto_websocket.research",
        vendor="alpaca",
        dataset="crypto_websocket",
        endpoint="wss://stream.data.alpaca.markets/v1beta3/crypto/us",
        auth_mode="headers",
        batching_mode="stream",
        pagination_mode="stream",
        task_kind="RESEARCH_ONLY",
        tier="C",
        enable_status="disabled",
        doc_status="doc_verified",
        live_status="live_failed",
        expected_history_years=0,
        required_fields=("symbol", "event_type", "vendor_ts", "raw_payload"),
        priority=274,
        lane_width=1,
        output_name="crypto_websocket_events",
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=30,
        explode_symbols=False,
        rotation_key="alpaca:crypto_websocket",
        doc_urls=("https://docs.alpaca.markets/docs/real-time-crypto-pricing-data",),
    ),
    VendorCapability(
        capability_id="alpaca.option_chain_reference.research",
        vendor="alpaca",
        dataset="option_chain_reference",
        ...
        live_status="live_failed",
        expected_history_years=0,
        required_fields=("symbol", "underlying_symbol", "indicative", "not_opra", "not_live_trade_approved"),
        priority=280,
        lane_width=1,
        output_name="option_snapshots",
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=1,
        explode_symbols=False,
        rotation_key="alpaca:option_chain",
        doc_urls=("https://docs.alpaca.markets/reference/optionchain",),
    ),
    VendorCapability(
        capability_id="alpaca.option_snapshots.research",
        vendor="alpaca",
        ...
        live_status="live_failed",
        expected_history_years=0,
        required_fields=("symbol", "indicative", "not_opra", "not_live_trade_approved"),
        priority=281,
        lane_width=1,
        output_name="option_snapshots",
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=100,
        explode_symbols=False,
        rotation_key="alpaca:option_snapshots",
        doc_urls=("https://docs.alpaca.markets/reference/optionsnapshots",),
    ),
    VendorCapability(
        capability_id="alpaca.option_bars.research",
        vendor="alpaca",
        dataset="option_bars",
        ...
        priority=282,
        lane_width=1,
        output_name="option_bars",
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=100,
        explode_symbols=False,
        rotation_key="alpaca:option_bars",
        doc_urls=("https://docs.alpaca.markets/reference/optionbars",),
    ),
    VendorCapability(
    ...
    VendorCapability(
        capability_id="tiingo.supported_tickers.reference",
        vendor="tiingo",
        ...
        priority=85,
        lane_width=1,
        output_name="tiingo_supported_tickers",
        planner_group="reference_events_backlog",
        explode_symbols=False,
        doc_urls=("https://www.tiingo.com/documentation/end-of-day",),
    ),
    VendorCapability(
    ...
    VendorCapability(
        capability_id="sec_edgar.form4_ownership.event",
        vendor="sec_edgar",
        dataset="form4_ownership",
        endpoint="/Archives/edgar/full-index/{year}/QTR{quarter}/form.idx",
        auth_mode="user_agent",
        batching_mode="global",
        ...
        live_status="live_verified",
        expected_history_years=20,
        required_fields=("archive_cik", "accession", "form", "filed_date"),
        priority=195,
        lane_width=1,
        output_name="sec_form4_manifest",
        planner_group="reference_events_backlog",
        explode_symbols=False,
        rotation_key="sec_edgar:form4_ownership",
        doc_urls=(
    ...
    VendorCapability(
        capability_id="sec_edgar.sec8k_index.event",
        vendor="sec_edgar",
        dataset="sec8k_index",
        endpoint="/Archives/edgar/full-index/{year}/QTR{quarter}/form.idx",
        auth_mode="user_agent",
        ...
        priority=196,
        lane_width=1,
        output_name="sec8k_manifest",
        planner_group="reference_events_backlog",
        explode_symbols=False,
        rotation_key="sec_edgar:sec8k_index",
        doc_urls=(
            "https://www.sec.gov/search-filings/edgar-search-assistance/accessing-edgar-data",
        ),
    ),
    ...
    VendorCapability(
        capability_id="alpha_vantage.news_sentiment.research",
        vendor="alpha_vantage",
        ...
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=10,
        rotation_key="alpha_vantage:news_sentiment",
        doc_urls=("https://www.alphavantage.co/documentation/",),
    ),
    VendorCapability(
        capability_id="fmp.stock_news.research",
        vendor="fmp",
        dataset="stock_news",
        ...
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=50,
        rotation_key="fmp:stock_news",
        doc_urls=("https://site.financialmodelingprep.com/developer/docs/",),
    ),
    VendorCapability(
        capability_id="fmp.press_releases.research",
        vendor="fmp",
        ...
        planner_group="supplemental_research_backlog",
        max_symbols_per_run=50,
        rotation_key="fmp:press_releases",
        doc_urls=("https://site.financialmodelingprep.com/developer/docs/",),
    ),
    VendorCapability(
...
_VENDOR_PROFILES: dict[str, VendorProfile] = {
    ...
    "tiingo": VendorProfile(
        ...
        avoid_for=(
            ...
            "news collection unless a live audit proves the account entitlement",
        ),
        ...
        notes="Treat Tiingo as the history specialist; its news lane is audit-only because the current free key is not entitled.",
    ),
