    ...
    "alpaca": ProviderContract(
        ...
        datasets=(
            ...
            DatasetContract(
                ...
                pagination_limit=10000,
                retry_after_header="X-RateLimit-Reset",
                docs_urls=("https://docs.alpaca.markets/reference/stocktrades",),
                notes="IEX historical trades are a raw microstructure archive lane; not used in Phase 1 features.",
            ),
            DatasetContract(
                ...
                pagination_limit=10000,
                retry_after_header="X-RateLimit-Reset",
                docs_urls=("https://docs.alpaca.markets/reference/stockquotes",),
                notes="IEX historical quotes are archived for future spread/liquidity features.",
            ),
            DatasetContract(
                ...
                max_batch_symbols=100,
                retry_after_header="X-RateLimit-Reset",
                docs_urls=("https://docs.alpaca.markets/reference/stocksnapshots",),
            ),
            DatasetContract(
                dataset="stock_bars_boats",
                endpoint_key="stock_bars_boats",
                max_batch_symbols=100,
                pagination_mode="page_token",
                pagination_limit=10000,
                retry_after_header="X-RateLimit-Reset",
                entitlement_failure_markers=("not entitled", "subscription", "forbidden"),
                docs_urls=("https://docs.alpaca.markets/reference/stockbars",),
                notes="Audit-gated Blue Ocean overnight bars; keep raw and separate from canonical IEX/SIP bars.",
            ),
            DatasetContract(
                dataset="stock_bars_otc",
                endpoint_key="stock_bars_otc",
                max_batch_symbols=100,
                pagination_mode="page_token",
                pagination_limit=10000,
                retry_after_header="X-RateLimit-Reset",
                entitlement_failure_markers=("not entitled", "subscription", "forbidden"),
                docs_urls=("https://docs.alpaca.markets/reference/stockbars",),
                notes="Audit-gated OTC bars; keep raw and separate from listed-equity canonical bars.",
            ),
            DatasetContract(
                dataset="crypto_bars",
                ...
                pagination_limit=10000,
                retry_after_header="X-RateLimit-Reset",
                docs_urls=("https://docs.alpaca.markets/reference/cryptobars-1",),
            ),
            DatasetContract(
                ...
                pagination_limit=10000,
                retry_after_header="X-RateLimit-Reset",
                docs_urls=("https://docs.alpaca.markets/reference/cryptotrades-1",),
            ),
            DatasetContract(
                ...
                pagination_limit=10000,
                retry_after_header="X-RateLimit-Reset",
                docs_urls=("https://docs.alpaca.markets/reference/cryptoquotes-1",),
            ),
            DatasetContract(
                ...
                max_batch_symbols=100,
                retry_after_header="X-RateLimit-Reset",
                docs_urls=("https://docs.alpaca.markets/reference/cryptosnapshots-1",),
            ),
            DatasetContract(
                dataset="crypto_websocket",
                endpoint_key="crypto_websocket",
                max_batch_symbols=30,
                retry_after_header=None,
                docs_urls=("https://docs.alpaca.markets/docs/real-time-crypto-pricing-data",),
                notes="Disabled by default until the Pi runtime has a dedicated long-lived websocket worker; REST capture remains scheduler-native.",
            ),
            DatasetContract(
                ...
                retry_after_header="X-RateLimit-Reset",
                entitlement_failure_markers=("not entitled", "subscription", "forbidden"),
                docs_urls=("https://docs.alpaca.markets/reference/optionchain",),
                notes="Indicative option chain snapshots only; not OPRA and not trade-approved.",
            ),
            DatasetContract(
                ...
                retry_after_header="X-RateLimit-Reset",
                entitlement_failure_markers=("not entitled", "subscription", "forbidden"),
                docs_urls=("https://docs.alpaca.markets/reference/optionsnapshots",),
                notes="Indicative option contract snapshots only; not OPRA and not trade-approved.",
            ),
            DatasetContract(
                dataset="option_bars",
                ...
                retry_after_header="X-RateLimit-Reset",
                entitlement_failure_markers=("not entitled", "subscription", "forbidden"),
                docs_urls=("https://docs.alpaca.markets/reference/optionbars",),
                notes="Historical option bars for discovered contract symbols; indicative/free entitlement only.",
            ),
            DatasetContract(
                dataset="assets",
                endpoint_key="assets",
